    ...
    >
      <div className="mx-auto max-w-5xl text-center">
        <div className="mx-auto max-w-4xl border border-white/55 bg-[rgb(248_246_228_/_0.95)] px-6 py-10 shadow-[0_22px_70px_rgba(73,79,74,0.16)] md:px-12 md:py-14">
          ...
          <p className="mx-auto mt-8 flex max-w-3xl flex-wrap items-center justify-center gap-x-3 gap-y-2 text-[0.78rem] leading-5 text-bp-blueGum/72 md:text-[0.82rem]">
            <Link
              to="/privacy"
